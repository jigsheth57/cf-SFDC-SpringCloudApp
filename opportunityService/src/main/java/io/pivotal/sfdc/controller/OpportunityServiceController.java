...
public class OpportunityServiceController {
	...
	/**
	 * Calls a opportunity service with opportunity object to create new opportunity
	 * in sfdc.
	 * 
	...
	public ResponseEntity<Opportunity> post(
			@ApiParam(value = "Opportunity model", required = true) @RequestBody Opportunity opportunity) {
	...
	/**
	 * Calls a opportunity service with opportunity object to update existing
	 * opportunity in sfdc.
	 * 
	...
	public ResponseEntity<Opportunity> put(
			@ApiParam(value = "Opportunity ID", required = true) @PathVariable String opportunityId,
			@ApiParam(value = "Opportunity model", required = true) @RequestBody Opportunity opportunity) {
		...
		try {
			...
			e.printStackTrace();
			LOGGER.error(String.format("Can not update existing opportunity with id %s: [%s]", opportunity.getId(),
					opportunity));
			return new ResponseEntity<Opportunity>(opportunity, new HttpHeaders(), HttpStatus.INTERNAL_SERVER_ERROR);
		}
	...
	/**
	 * Calls a opportunity service with opportunity id to delete opportunity from
	 * sfdc.
	 * 
	 * @return void
	 */
	...
	/**
	 * Calls a opportunity service with opportunity id to retrieve opportunity from
	 * sfdc.
	 * 
	...
	public ResponseEntity<Opportunity> get(
			@ApiParam(value = "Opportunity ID", required = true) @PathVariable String opportunityId) {
		HttpStatus httpstatus = HttpStatus.OK;
