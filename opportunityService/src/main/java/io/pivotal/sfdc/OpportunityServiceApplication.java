...
public class OpportunityServiceApplication {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("SFDC Opportunity Service API sample")
                .description("SFDC Opportunity Service API demo using Spring Cloud Services and SFDC Api")
