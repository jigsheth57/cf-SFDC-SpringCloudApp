...
pack build jigsheth57/configserver:2.3.1 --path configServer/target/configServer.jar --publish
pack build jigsheth57/authservice:2.3.1 --path authService/target/authService.jar --publish
